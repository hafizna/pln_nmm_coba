...
4. CB/DS are provisional SLD-derived objects and must be checked against detailed substation evidence.
...
See `../docs/08_CANONICAL_XML_GAP_RECAP.md` for the measured XML changes and
remaining gaps relative to the initial aggregate source.
